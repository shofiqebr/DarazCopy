  ...
  return (
    <footer className="mt-12 max-w-screen-xl mx-auto px-4 pb-12">
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-3">
        <div>
          <Link target="_blank" to="https://ioniccorporation.com/" className="text-[18px] font-semibold text-[#ff6801]">
            Customer Care
          </Link>
          <ul className="mt-2">
            <li>Help Center</li>
          ...
          <div className="mt-8">
            ...
            <ul className="mt-3">
              <li>IONIC University</li>
              <li>Sell on IONIC</li>
              <li>Code of IONIC</li>
              <li>Join the IONIC Affiliate Program</li>
            </ul>
          </div>
        </div>
        <div>
          <Link target="_blank" to="https://ioniccorporation.com/" className="text-[18px] font-semibold text-[#ff6801]">IONIC Corporation</Link>
          <ul className="mt-2">
            <li>About Ionic</li>
      ...
      <div className="py-4 text-sm border-t mt-6">
        <div className=" mx-auto">
          <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
            <div className="col-span-2 md:col-span-4 lg:col-span-6">
              Copyright 2024 <Link target="_blank" to="https://ioniccorporation.com/" className="font-bold ml-3 text-[#ff6801]">IONIC Corporation</Link>
            </div>
            <nav

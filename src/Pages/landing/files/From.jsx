...
const From = () => {
  ...
  return (
    <section className="max-w-screen-xl mx-auto px-3 mt-8">
      <div>
        <h1 className="text-3xl font-extrabold text-[#F85606] text-center">
          To Order fill up the form correctly
        </h1>
        <p className="text-xl font-extrabold max-w-screen-md mx-auto text-[#F85606] text-center mt-4 leading-10	">
      ...
      <section className="flex flex-col gap-6 md:flex-row justify-center mt-12 ">
        <div className="w-full md:flex-1">
          <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="">
              <button className="border border-[#F85606] p-5" type="submit">
                Buy Products
              </button>
            </div>
          </form>
